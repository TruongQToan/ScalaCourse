...
$c_Lcalculator_Calculator$.prototype.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D = (function(expr, references, dependency) {
  _evalRec: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if (dependency.contains__O__Z(name)) {
        return (NaN)
      } else {
        var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
        var temp$dependency = $as_sci_Set(dependency.$$plus__O__sc_Set(name));
        expr = temp$expr;
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(a, references, dependency) + this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(b, references, dependency))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(a$2, references, dependency) - this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(b$2, references, dependency))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(a$3, references, dependency) * this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(b$3, references, dependency))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      var dependency$1 = dependency;
      try {
        var this$2 = new $c_s_util_Success().init___O(($m_Lcalculator_Calculator$().calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(a$4, references, dependency$1) / $m_Lcalculator_Calculator$().calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(b$4, references, dependency$1)))
      } catch (e) {
        ...
        if ((e$2 !== null)) {
          matchEnd8: {
            ...
            if ((!o11.isEmpty__Z())) {
              ...
              var this$2 = new $c_s_util_Failure().init___jl_Throwable(e$3);
              break matchEnd8
            };
      ...
      return $uD((this$2.isSuccess__Z() ? this$2.get__O() : (NaN)))
    } else {
      return (NaN)
    }
  }
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  var dependency = $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()));
  return this.calculator$Calculator$$evalRec$1__Lcalculator_Expr__sci_Map__sci_Set__D(expr, references, dependency)
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      var b1 = $uD(b$2.apply__O());
      var a1 = $uD(a$2.apply__O());
      var delta1 = $uD(delta$1.apply__O());
      if ((delta1 < 0)) {
        ...
        var array$1 = [(((-b1) + $uD($g.Math.sqrt(delta1))) / (2.0 * a1)), (((-b1) - $uD($g.Math.sqrt(delta1))) / (2.0 * a1))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var a1 = $uD(a$1.apply__O());
      var b1 = $uD(b$1.apply__O());
      var c1 = $uD(c$1.apply__O());
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      ...
      return ((140 - $m_Lcalculator_TweetLength$().calculator$TweetLength$$tweetLength__T__I(text)) | 0)
    })
  })(tweetText));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var remains = $uI(remainingCharsCount$1.apply__O());
      return ((remains >= 15) ? "green" : (((remains >= 0) && (remains <= 14)) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
